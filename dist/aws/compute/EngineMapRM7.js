...
var AWSIcon = function AWSIcon(props) {
  ...
  return (// -- START of generated SVG source.
    _react.default.createElement("svg", _extends({
      ...
      height: size,
      viewBox: "0 0 100 100"
    }), _react.default.createElement("title", null, "Engine Map RM7"), _react.default.createElement("g", null, _react.default.createElement("path", {
      ...
      d: "M29.11,47.9h1.61l2.79,7.45,2.81-7.45h1.61v8.87H36.83V49.39h0L34,56.77H33l-2.77-7.38h0v7.38H29.11Z",
      fill: "#fff"
    }), _react.default.createElement("path", {
      d: "M45.43,56.74a1.43,1.43,0,0,1-.76.17c-.55,0-.89-.3-.89-1a2.85,2.85,0,0,1-2.26,1c-1.17,0-2.12-.52-2.12-1.8,0-1.45,1.08-1.76,2.17-2s2.16-.15,2.16-.94S43,51.13,42.3,51.13c-.89,0-1.55.27-1.6,1.22H39.64c.06-1.59,1.29-2.15,2.72-2.15,1.16,0,2.41.26,2.41,1.76v3.3c0,.5,0,.72.34.72a.9.9,0,0,0,.32-.06Zm-1.71-3.29a5.44,5.44,0,0,1-1.91.43c-.7.12-1.29.37-1.29,1.16s.6.94,1.24.94c1.39,0,2-.87,2-1.45Z",
      fill: "#fff"
    }), _react.default.createElement("path", {
      d: "M46.45,50.35H47.5v.87h0a2.16,2.16,0,0,1,2-1c2,0,3,1.56,3,3.38s-1,3.34-2.93,3.34a2.46,2.46,0,0,1-2.07-1h0v3.32H46.45Zm3,.78c-1.42,0-2,1.22-2,2.42S48,56,49.49,56s1.93-1.23,1.93-2.48S50.8,51.13,49.43,51.13Z",
      fill: "#fff"
    }), _react.default.createElement("path", {
      d: "M54,47.9h4.17c1.66,0,2.7.91,2.7,2.32a2.13,2.13,0,0,1-1.54,2.25v0c1,.2,1.24,1,1.33,1.83a4.54,4.54,0,0,0,.52,2.45H59.82c-.34-.36-.15-1.32-.32-2.19S59.16,53,58,53H55.13v3.79H54ZM57.59,52c1.11,0,2-.29,2-1.58a1.4,1.4,0,0,0-1.58-1.52H55.13V52Z",
      fill: "#fff"
    }), _react.default.createElement("path", {
      d: "M65.95,47.9h1.61l2.79,7.45,2.81-7.45h1.61v8.87H73.66V49.39h0l-2.77,7.38h-1l-2.77-7.38h0v7.38H65.95Z",
      fill: "#fff"
    }), _react.default.createElement("path", {
      d: "M82.1,49a13,13,0,0,0-3.38,7.75H77.54A12.62,12.62,0,0,1,81,49.1H76.4v-1h5.7Z",
      fill: "#fff"
