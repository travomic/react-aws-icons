...
var AWSIcon = function AWSIcon(props) {
  ...
  return (// -- START of generated SVG source.
    _react.default.createElement("svg", _extends({
      ...
      height: size,
      viewBox: "0 0 100 100"
    }), _react.default.createElement("defs", null), _react.default.createElement("title", null, "My SQL"), _react.default.createElement("path", {
      style: {
        "fill": "#19486f"
      },
      ...
      d: "M31.25,28.08h3.1l1.48,7.31h0l1.49-7.31h3.09V38.43H38.53V30.17h0l-1.84,8.26H35L33.2,30.17h0v8.26H31.25Z"
    }), _react.default.createElement("path", {
      style: {
        "fill": "#fff"
      },
      d: "M41.55,39.49a3.24,3.24,0,0,0,.52,0c.74,0,1-.41,1.07-1.1L41,30.63H43L44.2,36h0l1-5.39h2l-1.88,7.28c-.7,2.7-1.15,3.07-3,3.07h-.81Z"
    }), _react.default.createElement("path", {
      style: {
        "fill": "#fff"
      },
      d: "M50.45,35.2v.3c0,1,.28,1.59,1.38,1.59a1.19,1.19,0,0,0,1.25-1.28c0-.94-.48-1.29-1.86-1.77-1.86-.64-2.71-1.41-2.71-3.13,0-2,1.23-3,3.2-3s3.2.8,3.2,2.78V31h-2c0-1-.33-1.54-1.13-1.54a1.07,1.07,0,0,0-1.19,1.2c0,.64.19,1,1.07,1.41l1.61.7c1.57.68,2,1.48,2,2.74,0,2.19-1.33,3.17-3.59,3.17s-3.29-1.1-3.29-3V35.2Z"
    }), _react.default.createElement("path", {
      style: {
        "fill": "#fff"
      },
      d: "M61.9,39.71l-1.23-1.28a2.72,2.72,0,0,1-.64.16,5.58,5.58,0,0,1-.74,0c-3.13,0-3.52-2.23-3.52-5.38s.39-5.38,3.52-5.38,3.52,2.23,3.52,5.38a7.57,7.57,0,0,1-.8,4.2l1.12,1.13ZM59.29,37.1c1.23,0,1.43-1.06,1.43-3.84s-.2-3.84-1.43-3.84-1.44,1.07-1.44,3.84S58.06,37.1,59.29,37.1Z"
    }), _react.default.createElement("path", {
      style: {
        "fill": "#fff"
      },
      d: "M63.73,38.43V28.08h2.09v8.64h3.7v1.71Z"
    }), _react.default.createElement("path", {
      style: {
        "fill": "#fff"
      },
